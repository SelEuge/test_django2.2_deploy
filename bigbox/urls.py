...
urlpatterns = [
    ...
    path('box', views.ListAllBoxes.as_view(), name="box"),
    path('box/<box_id>/', views.DetailBox.as_view()),
    path('box/<box_id>/activity', views.ListActivitiesByBox.as_view(), name="activities"),
    path('box/<box_id>/activity/<activity_id>/', views.ShowActivityByBox.as_view()),
